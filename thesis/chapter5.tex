...
\begin{table}[htbp]
  ...
  (\texttt{Aws\allowbreak Internal\allowbreak Function\allowbreak Resolver}), $R{=}F$.}
  \label{tab:eval-p10}
...
\begin{table}[htbp]
  ...
  (\texttt{Workflow\allowbreak Internal\allowbreak Function\allowbreak Resolver}), $R{=}F$.}
  \label{tab:eval-p11}
  \begin{tabular}{lrrrrr}
    \hline
    $F\backslash N$ & 1 & 5 & 10 & 50 & 200 \\
