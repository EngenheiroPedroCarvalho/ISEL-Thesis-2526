...
\texttt{internalFunction(name, \allowbreak deployment\allowbreak Descriptor\allowbreak Path)} construct added to the \texttt{call}
...
deploys it through QuickFaaS, writing the resulting metadata back to the registry.
...
\texttt{arn:aws:states:::lambda:invoke} integration rather than an HTTP task.
