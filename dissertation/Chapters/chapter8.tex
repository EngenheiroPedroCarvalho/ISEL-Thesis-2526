...
\begin{enumerate}
  ...
  also retire the heuristic that recognises first-generation functions by their URL, which the
  second generation's own \texttt{cloudfunctions.net} endpoint
  defeats~\cite{gcpFunctionsVersionComparison}. The cost falls on QuickFaaS: the request body is
