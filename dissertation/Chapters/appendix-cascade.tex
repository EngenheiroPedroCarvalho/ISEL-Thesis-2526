...
\begin{figure}[htb]
  ...
  attempt rediscovery (across every region, or in the one region a \texttt{"region/functionRef"}
  reference names) before a stale entry is removed. On GCP, bindings to
...
\begin{figure}[htb]
  ...
  The operational steps of the AWS branch are traced in Figure~\ref{fig:aws-deploy-sequence}.}
