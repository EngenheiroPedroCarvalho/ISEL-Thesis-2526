...
The deployment of a cloud-agnostic function in QuickFaaS follows a structured pipeline that converts source code into a cloud-ready artifact. % , a process visually represented in Figure \ref{fig:function_deployment}.
...
OmniFlow models a workflow as a root \textbf{Workflow} entity that is \emph{composed by} one or more steps. % , as illustrated in the abstract model of Figure~\ref{fig:abstract-workflow-definition}.
...
% Although Figure~\ref{fig:abstract-workflow-definition} hides low-level fields,
...
% As shown in Figure~\ref{fig:omniflow_sequence},
