...
It then analyses the two base technologies this dissertation extends: \textbf{QuickFaaS}, which handles the portable deployment of compute units, and \textbf{OmniFlow}, which manages the portable definition of orchestration logic. Chapter~\ref{ch:related-works} reviews related research and existing industry tools, identifying the gap in unified workflow orchestration that this work aims to close.
