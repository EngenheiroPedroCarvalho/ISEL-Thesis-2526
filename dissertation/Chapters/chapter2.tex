...
\begin{enumerate}
	...
	\texttt{function-configs.json} packaged with the function and read at execution time through the
	QuickFaaS libraries. Both fall back to an empty default when omitted.
