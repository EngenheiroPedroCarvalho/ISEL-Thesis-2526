...
that is the variable the next experiment isolates. The $N{=}10$ point is noise --- its value,
...
\begin{figure}[htbp]
  ...
  internal line then grows with $N$. The error bar at $N{=}10$ reaches almost down to zero.}
  \label{fig:eval-t1}
\end{figure}
