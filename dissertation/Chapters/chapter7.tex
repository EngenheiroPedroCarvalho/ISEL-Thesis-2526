...
\paragraph{The single-read optimization (T3).}
...
\begin{figure}[htbp]
  \centering
  {\captionsetup{textfont=sf}\captionof{table}{T3 --- total resolution time ($\mu$s), naive (per-call read) vs.\ optimized (single
  read).}
  \label{tab:eval-t3}}
  \small
  ...
  \vspace{4mm}
  \includegraphics[width=0.62\textwidth]{images/benchmarks/T3a_resolution_sem_cache.png}\\[2mm]
  \includegraphics[width=0.62\textwidth]{images/benchmarks/T3b_resolution_com_cache.png}
  {\captionof{figure}{T3 --- reading the registry once per call (top) against reading it once per resolution
...
\begin{figure}[htbp]
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    {\captionsetup{textfont=sf}\captionof{table}{T4 --- optimized (single-read) resolution time ($\mu$s) of a real workflow, same grid
  ...
  \vspace{4mm}
  \includegraphics[width=0.62\textwidth]{images/benchmarks/T4a_resolution_sem_cache.png}\\[2mm]
  \includegraphics[width=0.62\textwidth]{images/benchmarks/T4b_resolution_com_cache.png}
  {\captionof{figure}{T4 --- resolution of a real \texttt{Workflow} object, naive (top) against optimized
...
$46\times$ at $R{=}1000$ (Table~\ref{tab:eval-t5} and Figure~\ref{fig:eval-t5}). The optimized
...
\begin{figure}[htbp]
  ...
  \vspace{4mm}
  \includegraphics[width=0.7\textwidth]{images/benchmarks/T6_aws_internal_resolution.png}
  {\captionof{figure}{T6 --- AWS provider: resolution time of
...
\begin{figure}[htbp]
  ...
  \vspace{4mm}
  \includegraphics[width=0.7\textwidth]{images/benchmarks/T7_google_internal_resolution.png}
  {\captionof{figure}{T7 --- GCP provider: resolution time of
...
\begin{figure}[htbp]
  ...
  \vspace{4mm}
  \includegraphics[width=0.7\textwidth]{images/benchmarks/T8_registry_write_scaling.png}
  {\captionof{figure}{T8 --- total time of $K$ successive \texttt{put} calls, one curve per initial registry
...
\begin{figure}[htbp]
  ...
  \vspace{4mm}
  \includegraphics[width=0.7\textwidth]{images/benchmarks/T9_registry_miss_and_deploy.png}
  {\captionof{figure}{T9 --- total time of $K$ successive miss+\texttt{put} pairs, one curve per initial
...
\begin{figure}[htbp]
  \centering
  {\captionsetup{textfont=sf}\captionof{table}{T11 --- resolution time ($\mu$s) of a mixed workflow, $R{=}F{=}10$ fixed;
  ...
  \vspace{4mm}
  \includegraphics[width=0.7\textwidth]{images/benchmarks/T11_resolution_internal_external_mix.png}
  {\captionof{figure}{T11 --- resolution time of a mixed workflow with $R{=}F{=}10$ fixed, one curve per
...
\begin{figure}[htbp]
  \centering
  {\captionsetup{textfont=sf}\captionof{table}{T12 --- resolution time ($\mu$s) vs.\ registry size $R$, mixed workflow with
  ...
  \begin{minipage}[c]{0.66\textwidth}
    \centering
    \includegraphics[width=\linewidth]{images/benchmarks/T12_resolution_by_registry_mixed.png}
  \end{minipage}
  {\captionof{figure}{T12 --- resolution time against registry size $R$ for a mixed workflow with
...
\begin{figure}[htbp]
  \centering
  {\captionsetup{textfont=sf}\captionof{table}{T13 --- resolution time ($\mu$s) vs.\ nesting depth, 20 internal calls fixed,
  $R{=}F{=}10$.}
  \label{tab:eval-t13}}
  \begin{minipage}[c]{0.31\textwidth}
    \centering
  ...
  \begin{minipage}[c]{0.66\textwidth}
    \centering
    \includegraphics[width=\linewidth]{images/benchmarks/T13_internal_resolution_by_nesting.png}
  \end{minipage}
  {\captionof{figure}{T13 --- resolution time against nesting depth with 20 internal calls and $R{=}F{=}10$
