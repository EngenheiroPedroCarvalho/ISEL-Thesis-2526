...
\begin{table}[htbp]
  \centering
  \caption{T2 --- per-call resolution cost as a function of registry size $R$, with the registry
...
(T3, T4, T5) --- a full \emph{identify (T2) $\rightarrow$ fix $\rightarrow$ quantify (T3)} loop.
