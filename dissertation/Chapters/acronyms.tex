...
% explicitly; glsignore drops the page number the list would otherwise show. This runs at the
% end of the document: at the start, its write to the .aux file produced a blank page before
% the cover.
\AtEndDocument{\glsaddall[types={\acronymtype},format=glsignore]}
