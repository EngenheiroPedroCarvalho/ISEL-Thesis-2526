...
\newglossaryentry{xor}{
	name={XOR invariant},
	description={Rule that a call step sets either \texttt{internalFunction} or a literal
	\texttt{host}/\texttt{path}, never both. The DSL builder enforces it and the resolvers check it
