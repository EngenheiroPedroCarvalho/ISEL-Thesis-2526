...
\begin{itemize}
    ...
    (\S\ref{subsec:validation-error-semantics}). First-generation Cloud Functions
...
both simply excluded from the candidate set while the scan runs, and are told apart only once it
ends, exactly as on the GCP path (\S\ref{subsec:validation-error-semantics}). What
