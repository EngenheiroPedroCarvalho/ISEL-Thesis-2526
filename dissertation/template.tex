...
\documentclass[
  ...
  fontstyle=verdana,    % baskervaldx bookman charter ebgaramond fbb fourier garamond
                        % heuristica kpfonts libertine mathpazo1 mathpazo2 newcent
                        % newpx newtx verdana(*)
  chapstyle=isel,       % bianchi bluebox brotherton dash default  
                        % elegant ell ger hansen isel(*) jenor lyhne 
                        % madsen pedersen veelo vz14 vz34 vz43
  otherlistsat=front,   % front(*), back
  linkscolor=darkblue,  % darkblue, black (Set to 'black' for PRINTING)
  printcommittee=true,  % set to 'false' from submitted versions who should not have 
  ...
  biblatex={            % Options for biblatex (see biblatex documentation)
	...
	memoir={	            % See the 'memoir' documentation
        ...
        11pt,               % 10pt, 11pt(*), 12pt
        % draft/final is controlled in Config/_memoir.tex, NOT here
     },
...
% Let biblatex break long URLs inside letter and digit runs, not only at the
% punctuation, so entries whose URL ends in a long word stay inside the margin.
\setcounter{biburllcpenalty}{7000}
\setcounter{biburlucpenalty}{8000}
\setcounter{biburlnumpenalty}{7000}

% Allow TeX a final, looser pass over paragraphs it cannot break otherwise,
% instead of letting a long identifier run into the margin.
...
\begin{document}
\printchecklist   % Only shows in draft mode
...
\printgantt             % Print Gantt diagram if file exists
