...
|---|---|
| §2.1.4.3 Workflow Development Cycle | mesmo número, com o título **Example: Function Chaining** (o parágrafo sobre as três fases repetia §2.1.4) |
...
- **Simetria no parágrafo do *deployment-time binding*** (§2.2.1, p. 15). Ao explicar os
