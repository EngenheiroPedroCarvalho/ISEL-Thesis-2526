...
\statementfile[pt]{statement-pt}
\statementfile[en]{statement-en}
...
\acknowledgementsfile{acknowledgments}
...
\addfile{chapter1}	% 1 Introduction
\addfile{chapter2}	% 2 Serverless Portability: Background and State of the Art
\addfile{chapter3}	% 3 Proposed Solution
\addfile{chapter5}	% 4 Implementation
\addfile{chapter6}	% 5 Case Study (placed before the Evaluation)
\addfile{chapter7}	% 6 Evaluation
\addfile{chapter8}	% 7 Conclusions
%\addfile{chapter-last}

%%------------------------------------------------------------
% Text appendices
% syntax: \appendixfile{filename}
\appendixfile{appendix-cascade}	% Resolution cascade sequence diagrams (replaces the template's appendix1)
%\appendixfile{appendix2}	% template placeholder (lorem ipsum)

%%------------------------------------------------------------
% Text annexes
% syntax: \annexfile{filename}
%\annexfile{annex1}	% template placeholder (lorem ipsum)
%\annexfile{annex2}	% template placeholder (lorem ipsum)
...
% \addlisttofrontmatter{\printlistofalgorithms}   % The List of Code Pseudocode. Comment to omit.
\addlisttofrontmatter{\listofacronyms}      % The List of Acronyms. Comment to omit.
% \addlisttofrontmatter{\listofsymbols}       % The List of Symbols. Comment to omit.
\addlisttofrontmatter{\printglossarylist}   % The Glossary. Comment to omit.
