...
\addfile{chapter2}	% 2 Background, 3 Related Works
\addfile{chapter3}	% 4 Proposed Solution
\addfile{chapter5}	% 5 Implementation
\addfile{chapter6}	% 6 Case Study (placed before the Evaluation)
\addfile{chapter7}	% 7 Evaluation
\addfile{chapter8}	% 8 Conclusions
